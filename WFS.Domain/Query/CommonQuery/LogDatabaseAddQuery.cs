...
namespace WFS.Domain.Query
{
    ...
    public class LogDatabaseAddQuery : IQuery<WFS.Entities.Models.LogDatabase>
    {
    	public WFS.Entities.Models.LogDatabase LogDatabase{ get; set; }
    }
    
    public class LogDatabaseAddQueryHandler : IQueryHandler<LogDatabaseAddQuery,WFS.Entities.Models.LogDatabase>
    {
    	...
    	public WFS.Entities.Models.LogDatabase Handler(LogDatabaseAddQuery query)
    	{
    		try
    		{
