...
namespace WFS.Domain.Query
{
    ...
    public class UserEditQuery : IQuery<WFS.Entities.Models.User>
    {
        public WFS.Entities.Models.User User { get; set; }
    }

    public class UserEditQueryHandler : IQueryHandler<UserEditQuery, WFS.Entities.Models.User>
    {
        ...
        public WFS.Entities.Models.User Handler(UserEditQuery query)
        {
            try
            {
